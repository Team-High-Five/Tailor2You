...
class M_Users
{
    ...
    {
        $this->db->query('INSERT INTO users (first_name, last_name, email, phone_number, nic, birth_date, home_town, address, bio, category, profile_pic, status, user_type) VALUES (:first_name, :last_name, :email, :phone_number, :nic, :birth_date, :home_town, :address, :bio, :category, :profile_pic, :status, :user_type)');
