            ...
            <div class="profile-form">
                <form action="<?php echo URLROOT; ?>/tailors/profileUpdate" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="bio" name="bio" placeholder="Tell us about yourself"><?php echo $data['tailor']->bio; ?></textarea>
                    ...
                    <div class="radio-group">
                        ...
                        <label>
                            <input type="radio" name="category" value="Gents" <?php echo $data['tailor']->category == 'Gents' ? 'checked' : ''; ?>> 
                            Gents
                        </label>
                        <label>
                            <input type="radio" name="category" value="Ladies" <?php echo $data['tailor']->category == 'Ladies' ? 'checked' : ''; ?>> 
                            Ladies
                        </label>
                        <label>
                            <input type="radio" name="category" value="Both" <?php echo $data['tailor']->category == 'Both' ? 'checked' : ''; ?>> 
                            Both
                        </label>
                    </div>
