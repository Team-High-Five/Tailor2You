    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <div class="left-column">
                ...
                <?php endif; ?>
                <p><?php echo $data['tailor']->first_name . ' ' . $data['tailor']->last_name; ?></p>
                <p><?php echo $data['tailor']->email; ?></p>
                <p><?php echo $data['tailor']->phone_number; ?></p>
            </div>
...
<script>
    ...
    function confirmCancel() {
        if (confirm('Are you sure you want to cancel?')) {
            window.location.href = '<?php echo URLROOT; ?>/admin/manageTailor';
        }
        return false;
    }
</script>
