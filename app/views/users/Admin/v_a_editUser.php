        ...
        <div class="form-section">
            ...
            <div class="left-column">
                <?php if (!empty($data['user']->profile_pic)): ?>
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($data['user']->profile_pic); ?>"
                ...
                <p><?php echo $data['user']->phone_number; ?></p>
            </div>

            <!-- Right Column: Form to Edit Details -->
            <div class="right-column">
                <form action="<?php echo URLROOT; ?>/admin/updateUser" method="POST" enctype="multipart/form-data" onsubmit="return confirmSave()">
                    <input type="hidden" name="user_id" value="<?php echo $data['user']->user_id; ?>">
                    <div class="row">
                        <div class="input-group">
                            <label for="first-name">First Name</label>
                            <input type="text" id="first-name" name="first_name" value="<?php echo $data['user']->first_name; ?>" required>
                        </div>
                        <div class="input-group">
                            <label for="last-name">Last Name</label>
                            <input type="text" id="last-name" name="last_name" value="<?php echo $data['user']->last_name; ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="phone" name="phone_number" value="<?php echo $data['user']->phone_number; ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-group">
                            <label for="nic">NIC</label>
                            <input type="text" id="nic" name="nic" value="<?php echo $data['user']->nic; ?>">
                        </div>
                        <div class="input-group">
                            <label for="birth_date">Birth Date</label>
                            <input type="date" id="birth_date" name="birth_date" value="<?php echo $data['user']->birth_date; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <select id="status" name="status" required>
                            ...
                            <option value="inactive" <?php if ($data['user']->status == 'inactive') echo 'selected'; ?>>Inactive</option>
                        </select>
                    </div>
...
<script>
    ...
    function confirmCancel() {
        if (confirm('Are you sure you want to cancel?')) {
            window.location.href = '<?php echo URLROOT; ?>/admin/viewAllUsers';
        }
        return false;
    }
</script>
