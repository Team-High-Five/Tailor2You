    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <div class="right-column">
                <form action="<?php echo URLROOT; ?>/admin/addTailor" method="POST" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="button-group">
                        ...
                        <a href="<?php echo URLROOT; ?>/admin/manageTailor" class="cancel-btn">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
