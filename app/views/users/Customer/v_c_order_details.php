...
<link rel='stylesheet' type='text/css' media='screen'
    href='<?php echo URLROOT; ?>/public/css/customer/order_details_styles.css'>
        ...
        <div class="order-header">
            <div class="order-title">
                ...
                <span class="order-date">Placed on
                    <?php echo date('d M Y', strtotime($data['order']->created_at)); ?></span>
            </div>
            ...
            <div class="section tailordetails">
                ...
                <div class="tailor-card">
                    <img src="<?php echo $data['tailor']->profile_pic ?
                        ...
                        URLROOT . '/public/img/default-profile.jpg'; ?>" alt="Tailor Profile">
                    <class="tailor-info">
            ...
            <div class="receipt">
                <div class="receipt-items">
                    ...
                    <div class="receipt-item">
                        ...
                        <?php if ($data['order']->actual_delivery_date == null): ?>
