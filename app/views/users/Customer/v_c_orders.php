                ...
                <div class="order-image">
                    <div class="image-wrapper">
                        <?php if ($order->main_image): ?>
                            <img src=" <?php echo URLROOT ?>/public/img/uploads/designs/<?php echo $order->main_image ?>"
                                alt="Design Image">
                        <?php else: ?>
...
<script>
    function ordersViews(orderId) {
        window.location.href = "<?php echo URLROOT; ?>/Customers/ordersViews/" + encodeURIComponent(orderId);
    }
</script>
