...
<!-- slider -->
<?php require_once APPROOT . '/views/pages/inc/components/women_slidebar.php'; ?>
<!-- Shop by Category Section -->
<span id="women-categories"></span>
<?php require_once APPROOT . '/views/pages/inc/components/women-category.php'; ?>
